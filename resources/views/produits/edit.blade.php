    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('produits.update', ['produit' => $produit->id]) }}" method="PUT">
                    @csrf
                    <div class="mb-4">
                        <label for="nom" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Nom</label>
                        <input type="text" id="nom" name="nom" min="0" required value="{{ old('nom', $produit->nom) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="quantiteRecolte" name="quantiteRecolte" min="0" required value="{{ old('quantiteRecolte', $produit->quantiteRecolte) }}"
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 dark:text-gray-100 leading-tight focus:outline-none focus:shadow-outline"
                    ...
                    <div class="mb-4">
                        <label for="dateRecolte" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Date
                            Récolte</label>
                        <input type="date" id="dateRecolte" name="dateRecolte" required value="{{ old('dateRecolte', $produit->dateRecolte) }}" 
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 dark:text-gray-100 leading-tight focus:outline-none focus:shadow-outline"
